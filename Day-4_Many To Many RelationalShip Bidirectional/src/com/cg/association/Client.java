...
public class Client 
{
	...
	public static void main(String[] args) 
	{
		...
		elecProduct.setId(10);
		elecProduct.setName("PHILIPS TV");
		elecProduct.setPrice(45000);

		Product beautyProduct = new Product();
		beautyProduct.setId(11);
		beautyProduct.setName("Speaker");
		beautyProduct.setPrice(80);

		Product babyProduct = new Product();
		babyProduct.setId(12);
		babyProduct.setName("Focus Light");
		babyProduct.setPrice(15);

		Product eleProduct = new Product();
		eleProduct.setId(13);
		eleProduct.setName("Small Bulb");
